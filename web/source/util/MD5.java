...
public class MD5 {
    ...
    public static String sign(String text, String key, String input_charset) {
    	text = text + key;
        return DigestUtils.md5DigestAsHex(getContentBytes(text, input_charset)).toUpperCase();
    }
    ...
    public static String sign(String text) {
        text = text + "&key=" + SwiftpassConfig.getKey();
        return DigestUtils.md5DigestAsHex(getContentBytes(text, "utf-8")).toUpperCase();
    }
